...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 08 مايو 2025 الساعة 16:22
-- إصدار الخادم: 9.1.0
-- PHP Version: 8.3.14
...
--
-- إرجاع أو استيراد بيانات الجدول `admin_profiles`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `general_setting`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `items_categories`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `mony_boxes`
--
...
('cIW6ZL8YpDTHem4RUArHy9u8MUG16Oyc3P3uGQIu', 9, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:138.0) Gecko/20100101 Firefox/138.0', '', 1746721273);
...
CREATE TABLE IF NOT EXISTS `timezones` (
  ...
  `tz_value` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tz_group` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
--
-- إرجاع أو استيراد بيانات الجدول `timezones`
--
