...
return [
    [
        'name_ar' => 'ميدواي',
        'name_en' => 'Pacific/Midway',
        'tz_value' => '(UTC-11:00)'
    ],
    [
        'name_ar' => 'نيوي',
        'name_en' => 'Pacific/Niue',
        'tz_value' => '(UTC-11:00)'
    ],
    [
        'name_ar' => 'باغو باغو',
        'name_en' => 'Pacific/Pago_Pago',
        'tz_value' => '(UTC-11:00)'
    ],
    [
        'name_ar' => 'أداك',
        'name_en' => 'America/Adak',
        'tz_value' => '(UTC-10:00)'
    ],
    [
        'name_ar' => 'هونولولو',
        'name_en' => 'America/Honolulu',
        'tz_value' => '(UTC-10:00)'
    ],
    [
        'name_ar' => 'جونستون',
        'name_en' => 'America/Johnston',
        'tz_value' => '(UTC-10:00)'
    ],
    [
        'name_ar' => 'راروتونغا',
        'name_en' => 'Pacific/Rarotonga',
        'tz_value' => '(UTC-10:00)'
    ],
    [
        'name_ar' => 'تاتي',
        'name_en' => 'Pacific/Tahiti',
        'tz_value' => '(UTC-10:00)'
    ],
    [
        'name_ar' => 'ماركيساس',
        'name_en' => 'Pacific/Marquesas',
        'tz_value' => '(UTC-09:30)'
    ],
    [
        'name_ar' => 'انكorage',
        'name_en' => 'America/Anchorage',
        'tz_value' => '(UTC-09:00)'
    ],
    [
        'name_ar' => 'غانبير',
        'name_en' => 'Pacific/Gambier',
        'tz_value' => '(UTC-09:00)'
    ],
    [
        'name_ar' => 'جونيو',
        'name_en' => 'America/Juneau',
        'tz_value' => '(UTC-09:00)'
    ],
    [
        'name_ar' => 'نوم',
        'name_en' => 'America/Nome',
        'tz_value' => '(UTC-09:00)'
    ],
    [
        'name_ar' => 'سيتكا',
        'name_en' => 'America/Sitka',
        'tz_value' => '(UTC-09:00)'
    ],
    [
        'name_ar' => 'ياكتات',
        'name_en' => 'America/Yakutat',
        'tz_value' => '(UTC-09:00)'
    ],
    [
        'name_ar' => 'داسون',
        'name_en' => 'America/Dawson',
        'tz_value' => '(UTC-08:00)'
    ],
    [
        'name_ar' => 'لوس أنجلوس',
        'name_en' => 'America/Los_Angeles',
        'tz_value' => '(UTC-08:00)'
    ],
    [
        'name_ar' => 'متلاكتلا',
        'name_en' => 'America/Metlakatla',
        'tz_value' => '(UTC-08:00)'
    ],
    [
        'name_ar' => 'بيت كيرن',
        'name_en' => 'Pacific/Pitcairn',
        'tz_value' => '(UTC-08:00)'
    ],
    [
        'name_ar' => 'سانتا إيزابيل',
        'name_en' => 'America/Santa_Isabel',
        'tz_value' => '(UTC-08:00)'
    ],
    [
        'name_ar' => 'تيجاوانا',
        'name_en' => 'America/Tijuana',
        'tz_value' => '(UTC-08:00)'
    ],
    [
        'name_ar' => 'فينكوان',
        'name_en' => 'America/Vancouver',
        'tz_value' => '(UTC-08:00)'
    ],
    [
        'name_ar' => 'وايت هورس',
        'name_en' => 'America/Whitehorse',
        'tz_value' => '(UTC-08:00)'
    ],
    [
        'name_ar' => 'بيوسي',
        'name_en' => 'America/Boise',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'كامبريدج باي',
        'name_en' => 'America/Cambridge_Bay',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'شيكو',
        'name_en' => 'America/Chihuahua',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'كاسترون',
        'name_en' => 'America/Creston',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'داسون كريك',
        'name_en' => 'America/Dawson_Creek',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'دنفر',
        'name_en' => 'America/Denver',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'إدمونتون',
        'name_en' => 'America/Edmonton',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'هيرميسيلو',
        'name_en' => 'America/Hermosillo',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'ينفيك',
        'name_en' => 'America/Inuvik',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'مازاتلان',
        'name_en' => 'America/Mazatlan',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'أوجينا',
        'name_en' => 'America/Ojinaga',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'فنيكس',
        'name_en' => 'America/Phoenix',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'شيبروك',
        'name_en' => 'America/Shiprock',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'أويلنفاي',
        'name_en' => 'America/Yellowknife',
        'tz_value' => '(UTC-07:00)'
    ],
    [
        'name_ar' => 'بيهيا باندراس',
        'name_en' => 'America/Bahia_Banderas',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'بيليز',
        'name_en' => 'America/Belize',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'بيولا',
        'name_en' => 'America/North_Dakota/Beulah',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'كانكون',
        'name_en' => 'America/Cancun',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'مركز شمال داكوتا',
        'name_en' => 'America/North_Dakota/Center',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'شيكاغو',
        'name_en' => 'America/Chicago',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'كosta Rica',
        'name_en' => 'America/Costa_Rica',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'إستير',
        'name_en' => 'Pacific/Easter',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'إل ساليفادور',
        'name_en' => 'America/El_Salvador',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'Galapagos',
        'name_en' => 'Pacific/Galapagos',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'غواتيمالا',
        'name_en' => 'America/Guatemala',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'كونغ',
        'name_en' => 'America/Indiana/Knox',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'ماناغا',
        'name_en' => 'America/Managua',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'مانوميني',
        'name_en' => 'America/Menominee',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'ميرايدا',
        'name_en' => 'America/Merida',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'مكسيكو سيتي',
        'name_en' => 'America/Mexico_City',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'مونترري',
        'name_en' => 'America/Monterrey',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'نيو ساليم',
        'name_en' => 'America/North_Dakota/New_Salem',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'ريني رير',
        'name_en' => 'America/Rainy_River',
        'tz_value' => '(UTC-06:00)'
    ],
    [
        'name_ar' => 'رانيكين إينلت',
        'name_en' => 'America/Rankin_Inlet',
        'tz_value' => '(UTC-06:00)'
    ],
    ...
    [
        'name_ar' => 'لندن',
        'name_en' => 'Europe/London',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'ماديرا',
        'name_en' => 'Atlantic/Madeira',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'مونروفيا',
        'name_en' => 'Africa/Monrovia',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'نواكشوط',
        'name_en' => 'Africa/Nouakchott',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'واجادوجو',
        'name_en' => 'Africa/Ouagadougou',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'ريكيافيك',
        'name_en' => 'Atlantic/Reykjavik',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'ساو تومي',
        'name_en' => 'Africa/Sao_Tome',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'سانت هيلانة',
        'name_en' => 'Atlantic/St_Helena',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'التوقيت العالمي',
        'name_en' => 'UTC',
        'tz_value' => '(UTC+00:00)'
    ],
    [
        'name_ar' => 'الجزائر',
        'name_en' => 'Africa/Algiers',
        'tz_value' => '(UTC+01:00)'
    ],
    [
        'name_ar' => 'أمستردام',
        'name_en' => 'Europe/Amsterdam',
        'tz_value' => '(UTC+01:00)'
    ],
    [
        'name_ar' => 'أندورا',
        'name_en' => 'Europe/Andorra',
        'tz_value' => '(UTC+01:00)'
    ],
    [
        'name_ar' => 'bangui',
        'name_en' => 'Africa/Bangui',
        'tz_value' => '(UTC+01:00)'
    ],
    [
        'name_ar' => 'بلغراد',
        'name_en' => 'Europe/Belgrade',
        'tz_value' => '(UTC+01:00)'
    ],
    [
        'name_ar' => 'برلين',
        'name_en' => 'Europe/Berlin',
        'tz_value' => '(UTC+01:00)'
    ],
    [
        'name_ar' => 'براتيسلافا',
        'name_en' => 'Europe/Bratislava',
        'tz_value' => '(UTC+01:00)'
    ],
    [
        'name_ar' => 'برازواي',
        'name_en' => 'Africa/Brazzaville',
        'tz_value' => '(UTC+01:00)'
    ],
    [
        'name_ar' => 'بروكسل',
        'name_en' => 'Europe/Brussels',
        'tz_value' => '(UTC+01:00)'
    ],
