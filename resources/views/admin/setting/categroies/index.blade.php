  ...
  <div class="row">
    <div class="col-md-12">
      <div id="units-container">
        <h1 class="mt-3 pb-2" style="border-bottom: 1px solid #dedede">{{__('contact.categories-list')}}
            ...
            <div class="modal-content">
              ...
              <form class="p-3" method="POST" action="{{ route('store-new-category') }}">
                ...
                <div class="mb-2 input-group sm">
                  ...
                  <input type="text" name="cat_breif" class="form-control" value="{{ old('cat_breif') }}">
                </div>
                @error('cat_breif')
                <div class="text-danger">{{ $message }}</div>
                @enderror
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <form class="p-3" method="POST" action="{{ route('update-category-info', $categoryToEdit->id) }}">
                ...
                <div class="mb-2 input-group sm">
                  <label class="input-group-text">{{__('categories.brief')}}</label>
                  <input type="text" name="cat_breif" class="form-control" value="{{ old('cat_breif', $categoryToEdit->cat_breif) }}">
                </div>
                @error('cat_breif')
                <div class="text-danger">{{ $message }}</div>
                @enderror
