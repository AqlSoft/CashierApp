                  ...
                  <div class="input-group sm mt-2">
                    ...
                    <select class="form-select form-control sm py-0" name="monybox_id" id="monybox_id" required>
                      ...
                      <option value="{{ $monyBox->id }}">
                        ...
                        {{ __('sessions.box_has_active_session') }}
                        @endif
                      </option>
                      @endforeach
                    </select>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{ route('edit-sales-session-info',  $session) }}" class="btn btn-sm btn-warning" title="{{ __('sessions.edit') }}">
                <i class="fas fa-edit"></i>
              </a>
              <a href="{{ route('destroy-sales-session-info', $session) }}" class="btn btn-sm btn-danger" title="{{ __('sessions.delete') }}">
                <i class="fas fa-trash"></i>
              </a>
              @if($session->status == 'Active')
              <a href="{{ route('sales-session.close', $session->id) }}" class="btn btn-sm btn-secondary" title="{{ __('sessions.close_session') }}">
