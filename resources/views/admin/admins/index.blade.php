        ...
        <div class="col-md-12">
            <div id="products-container">
                ...
                <h1 class="mt-3 pb-2" style="border-bottom: 1px solid #dedede">Client List
                    <a data-bs-toggle="modal" data-bs-target="#createNewAdmin"><span data-bs-toggle="tooltip" data-bs-title="Create New Admin"></span><i class="fa fa-plus"></i></span></a>
                </h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('destroy-admin-info', $admin->id)}}" method=post>
                                    @csrf
                                    @method('delete')
                                    <a class="btn btn-sm py-0" href="{{ route('display-admin-info', $admin->id) }}"><i
                                            class="fas fa-eye text-success" title="View Details"></i></a>
                                    <a class="btn btn-sm py-0" href="{{ route('edit-admin-info', $admin->id) }}"><i
                                            class="fa fa-edit text-primary"></i></a>
                                    <button class="btn btn-sm py-0" onclick="if(!confirm('You are about to delete a order, are you sure!?.')){return false}"
                                        title="Delete order and related Information" href="{{ route('destroy-admin-info', $admin->id) }}"><i
...
<div class="modal fade mt-5 pt-5" id="createNewAdmin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="createNewAdminLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('store-admin-info')}}" method="POST">
                    ...
                    <div class="input-group sm mb-2">
                        <button type=submit class="input-group-text btn btn-sm btn-outline-primary"><i class="fa fa-save"></i>Save User</button>
                        <button type="button" data-bs-dismiss="modal" class="input-group-text btn btn-sm btn-outline-secondary"><i class="fa fa-times"></i>Cancel</button>
                    </div>
                </form>
            </div>
        </div>
