                        ...
                        @forelse ($orders as $pendingOrder)
                            <div class="swiper-slide">
                                ...
                                <a href="{{ route('add-orderitem', [$pendingOrder->id]) }}"
                                    title="Order SN - {{ $pendingOrder->order_sn }}" class="btn btn-sm {{ $btnClass }}">
                ...
                <div class="row mt-2">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-outline-info"
                            href="{{ route('change-order-delivery-method', [$order->id, 2]) }}">Local</a>
                    ...
                    <div class="col col-12">
                        ...
                        <form method="POST" action="{{ route('update.delivery.method') }}">
                            @csrf
                            <input type="hidden" name="order_id" value="{{ $order->id }}">

                            <div class="button-group mb-2 sm">
                                @foreach ($deliveryMethods as $value => $label)
                                    <button type="submit" name="selected_method" value="{{ $value }}"
                        ...
                        @if ($currentMethod == 2)
                            <div class="input-group sm mb-2">
                                ...
                                <select class="form-select form-control sm py-0" name="table_id" required>
                                ...
                                <div class="row g-0 border-bottom py-2 align-items-center">
                                    <form action="{{ route('update-orderitem') }}" method="post"
                                        ...
                                        <div class="col-2 text-end fs-6">
                                            {{ number_format($oItem->quantity * $oItem->price, 2) }}</div>
