                    ...
                    <div class="tab-pane fade show active" id="PersonalInfo" role="tabpanel"
                        ...
                        <div class="profile-container ">
                            <div class="profile-header">
                                <<<<<<< HEAD <h4>Update Your Personal Info</h4>
                            </div>
                            ...
                            <div class="row mb-4 text-center">
                                ...
                                <div class="row mb-4 ">
                                    <div class=" col col-4">
                                        >>>>>>> 429fb2a9dab8497923dd2b0a0f8df525836911d0
                                                ...
                                                <form method="POST" action="{{ route('admins.update', $admin->id) }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col col-7 text-start ">
                                                            <input type="text" class="form-control sm py-0 "
                                                                name="userName"
                                    ...
                                    <div class="row mt-2">
                                        <div class="col col-12">
                                            <div class="selected-products-container" style="font-size: 14px;">
                                                <!-- Header Row -->
                                                <div
                                                    class="row g-0 border-bottom py-2  fw-bold align-items-center table-header">
                                                ...
                                                @foreach ($admin->shifts as $shift)
                                                    <div class="row g-0 border-bottom py-2 align-items-center">
                                                        ...
                                                        <div class="col-3 text-center fs-6">
                                                            {{ $shift->start_time->format('d/m/Y H:i') }}</div>
                                                        <div class="col-3 text-center fs-6">
                                                            @if ($shift->end_time)
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col col-8 mb-2 ">
                                                                        <form method="POST"
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col col-5 fw-bold text-end">Job
                                                                                    Title:</div>
                                                                                <div class="col col-7">
                                                                                    <input type="text" name="job_title"
                                                                                        class="form-control sm py-0"
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col col-12">
                                                            <div class="selected-products-container"
                                                                ...
                                                                <div
                                                                    class="row g-0 border-bottom py-2  fw-bold align-items-center ">
                                                                    <div class="col-1 text-center fw-bold">#</div>
                                                                    <div class="col-3 fw-bold">Session Name</div>
                                                                    <div class="col-3 text-center fw-bold">Start Time</div>
                                                                    <div class="col-3 text-center fw-bold">End Time</div>
                                                                ...
                                                                @foreach ($admin->shifts as $shift)
                                                                    <div
                                                                        class="row g-0 border-bottom py-2 align-items-center">
                                                                        <div class="col-1 text-center fs-6">
                                                                            {{ $loop->iteration }}</div>
                                                                        <div class="col-3 ps-2 fs-6">
                                                                            {{ $shift->monybox->name }}</div>
                                                                        <div class="col-3 text-center fs-6">
                                                                        ...
                                                                        <div class="col-3 text-center fs-6">
                                                                            @if ($shift->end_time)
                                                                                {{ $shift->end_time->format('d/m/Y H:i') }}
                                                                            @else
                                                                                <span class=" btn btn-sm btn-warning">In
                                                                                    Progress</span>
                                                                            @endif
                                                                        </div>
                                                                        <div class="col-2 text-center fs-6">
                                                                            @if ($shift->status == 'Active')
                                                                                <span
                                                                                    class="btn btn-sm btn-success">Active</span>
                                                                            @else
                                                                                <span
                                                                                    class="btn btn-sm btn-secondary">Closed</span>
                                                                            @endif
                                                                        </div>
