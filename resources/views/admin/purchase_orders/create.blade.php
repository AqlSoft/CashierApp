    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.purchase-orders.store') }}" method="POST" id="purchase-order-form">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>إجمالي الخصم</th>
                                        <td>
                                            <input type="number" id="discount-amount" class="form-control" readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>المبلغ النهائي</th>
                                        <td>
                                            <input type="number" id="final-amount" class="form-control" readonly>
                                        </td>
                                    </tr>
                                </table>
                            </div>
...
$(function () {
    ...
    function calculateTotals() {
        ...
        $('.product-row').each(function() {
            ...
            $(this).find('.total-price').val(rowTotal);
        });
