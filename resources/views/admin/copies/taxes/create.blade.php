    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <form action="{{ route('taxes.store') }}" method="POST" id="tax-form">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tax_code') is-invalid @enderror" 
                                           id="tax_code" name="tax_code" value="{{ old('tax_code') }}" required>
                                    @error('tax_code')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tax_type') is-invalid @enderror" 
                                        ...
                                        <option value="FIXED_AMOUNT" {{ old('tax_type') == 'FIXED_AMOUNT' ? 'selected' : '' }}>قيمة ثابتة</option>
                                    </select>
                                    @error('tax_type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tax_name_ar') is-invalid @enderror" 
                                           id="tax_name_ar" name="tax_name_ar" value="{{ old('tax_name_ar') }}" required>
                                    @error('tax_name_ar')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tax_name_en') is-invalid @enderror" 
                                           id="tax_name_en" name="tax_name_en" value="{{ old('tax_name_en') }}" required>
                                    @error('tax_name_en')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" 
                                               ...
                                               id="tax_rate" name="tax_rate" value="{{ old('tax_rate') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('gl_account_code') is-invalid @enderror" 
                                           id="gl_account_code" name="gl_account_code" value="{{ old('gl_account_code') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control @error('tax_groups') is-invalid @enderror" 
                                ...
                                @foreach($taxGroups as $group)
                                    <option value="{{ $group->id }}" {{ in_array($group->id, old('tax_groups', [])) ? 'selected' : '' }}>
                                        {{ $group->group_name }}
                                    </option>
                                @endforeach
                            </select>
