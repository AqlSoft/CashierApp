...
@section('title', 'إضافة مجموعة ضرائب جديدة')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <form action="{{ route('admin.tax-groups.store') }}" method="POST" id="tax-group-form">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('group_code') is-invalid @enderror" 
                                           id="group_code" name="group_code" value="{{ old('group_code') }}" required>
                                    @error('group_code')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('group_name_ar') is-invalid @enderror" 
                                           id="group_name_ar" name="group_name_ar" value="{{ old('group_name_ar') }}" required>
                                    @error('group_name_ar')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('group_name_en') is-invalid @enderror" 
                                           id="group_name_en" name="group_name_en" value="{{ old('group_name_en') }}" required>
                                    @error('group_name_en')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
