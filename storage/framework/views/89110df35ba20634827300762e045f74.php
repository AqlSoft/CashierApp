    ...
    <div
      ...
      <form action="<?php echo e(route('update-monyBox-info')); ?>" method="POST">
        ...
        <div class="input-group sm mb-2">
                      ...
                      <input type="text" class="form-control sm" name="name" id="name" value="<?php echo e(old('name',$m_box)); ?>">
                      
                  
                      <label class="input-group-text" for="date"> Date</label>
                      <input type="text" value="<?php echo e(old('date',$m_box)); ?>"  class="fc-datepicker form-control sm " name="date" id="date">
                    </div>
                    <div class="input-group sm mt-2">
                      <label class="input-group-text" for="last_isal_exhcange">Last Exhcange</label>
                      <input type="text" class="form-control sm" name="last_isal_exhcange" id="last_isal_exhcange" value="<?php echo e(old('last_isal_exhcange',$m_box)); ?>">
                      <label class="input-group-text" for="last_isal_collect">Last Collection</label>
                      <input type="text" class="form-control sm" name="last_isal_collect" id="last_isal_collect"  value="<?php echo e(old('last_isal_collect',$m_box)); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\kashear_project\resources\views/admin/monyboxes/edit.blade.php ENDPATH**/ ?>