  ...
  <table class="table table-bordered table-sm mt-1  ">
    ...
    <tfoot>
      <tr>
        ...
        <td class="price"><?php echo e($invoice->amount); ?></td>
      </tr>
      <tr>
        <td colspan="4" class="fw-bold text-end">Vat Amount</td>
        <td class="price"><?php echo e($invoice->vat_amount); ?></td>
      </tr>
      <tr>
        <td colspan="4" class="fw-bold text-end">Total Amount</td>
        <td class="price"><?php echo e($invoice->total_amount); ?></td>
      </tr>
    </tfoot>
  </table>
...
<?php echo $__env->make('layouts.reports.template1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\kashear_project\resources\views/admin/invoices/view.blade.php ENDPATH**/ ?>