                                ...
                                <form action="">
                                    ...
                                    <td>
                                        <a class="btn btn-sm py-0" onclick="if(!confirm('You are about to delete a item, are you sure!?.')){return false}"
                                            title="delete order and related Information" href="<?php echo e(route('destroy-oItem-info', $oItem->id)); ?>">
            ...
            <form id="cash-payment-form" action="<?php echo e(route('payments.cash.store')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group sm mb-1">
                        ...
                        <input type="number" step="0.01" class="form-control sm" name="remaining" id="remaining" value="<?php echo e($remaining); ?>" required readonly>
                    </div>
