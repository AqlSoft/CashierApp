                ...
                <ul class="nav nav-tabs my-2" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="edit-admin-info-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="true"><?php echo e(__('admins.edit_admin_info')); ?></button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" id="admin-permissions-tab" data-bs-toggle="tab" data-bs-target="#admin-permissions"
                            type="button" role="tab" aria-controls="admin-permissions" aria-selected="false"><?php echo e(__('admins.permissions')); ?></button>
                    </li>
                </ul>
                                ...
                                <div class="card w-100">
                                    <div class="card-header">
                                        <h5 class="card-title py-2">
                                            <?php echo e(__('admins.account_basic_info')); ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group sm mb-2">
                                                ...
                                                <input type="text" class="form-control sm" name="userName" id="userName"
                                                    value="<?php echo e(old('userName', $admin->profile)); ?>">
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                            <div class="input-group sm mb-2">
                                                ...
                                                <input type="email" class="form-control sm" name="email" id="email"
                                                    value="<?php echo e(old('email', $admin->profile)); ?>">
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="input-group sm mb-2">
                                                <label class="input-group-text" for="role_name"><?php echo e(__('admins.role')); ?></label>
                                                <select class="form-select sm" name="role_name" id="role_name"
                                                    value="<?php echo e(old('role_name', $admin->profile)); ?>">
                                                    <option hidden><?php echo e(__('admins.select_role')); ?></option>
                                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($role); ?>"><?php echo e(__('admins.' . $role)); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="card-footer d-flex justify-content-end">
                                            <button type="submit" class="btn py-0 btn-outline-primary">
                                                <i class="fa fa-save me-2"></i><?php echo e(__('admins.update')); ?>
                            ...
                            <div class="col col-4 mb-3 p-1">
                                <div class="card w-100">
                                    ...
                                    <form action="<?php echo e(route('update-admin-password')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="card-body">
                                            <div class="input-group sm mb-2">
                            ...
                            <div class="col col-6 mb-3 p-1">
                                <div class="card w-100">
                                    <div class="card-header">
                                        <h5 class="card-title py-2"><?php echo e(__('admins.profile_identity')); ?></h5>
                                    </div>
                                    <form action="<?php echo e(route('update-admin-info')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('put'); ?>
                                        ...
                                        <div class="input-group sm mb-2">
                                            ...
                                            <input type="text" class="form-control sm" name="first_name" id="first_name" value="<?php echo e(old('first_name', $admin->profile)); ?>">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                        <div class="input-group sm mb-2">
                                            ...
                                            <input type="text" class="form-control sm" name="last_name" id="last_name" value="<?php echo e(old('last_name', $admin->profile)); ?>">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col col-12 mb-3 p-1">
                            <div class="card w-100">
                                <div class="card-header">
                                    <h5 class="card-title py-2"><?php echo e(__('admins.admin_roles_assignment')); ?></h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <p><?php echo e(__('admins.no_roles_found')); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="admin-permissions" role="tabpanel" aria-labelledby="admin-permissions" tabindex="0">
                        <h5><?php echo e(__('admins.admin_permissions')); ?></h5>
                        <div class="row">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <p><?php echo e(__('admins.no_permissions_found')); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
