        ...
        <div class="col-lg-12 col-sm-12">
          <div class="bulk border-dark p-0 m-1">
            ...
            <div class="row m-0 mb-1  border-bottom border-dark-50 pb-1">
              ...
              <?php if($product->status == \App\Models\Product::PRODUCT_JUST_CREATED): ?>
              <div class="col col-9  text-success"><?php echo e(\App\Models\Product::getStatusPro()[$product->status]?? ''); ?></div>
              <?php else: ?>
              <div class="col col-9  text-danger"><?php echo e(\App\Models\Product::getStatusPro()[$product->status]?? ''); ?></div>
              <?php endif; ?>
            </div>
