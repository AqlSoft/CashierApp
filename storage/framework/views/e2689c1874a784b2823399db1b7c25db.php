          ...
          <div class="col-lg-10 col-sm-10">
            <div class="bulk border-dark p-0 m-1">
              ...
              <div class="row m-0 mb-1 border-bottom border-dark-50 pb-1">
                ...
                <div class="col col-2">
                  <input type="text" class="form-control disabled" readonly id="processing_time" value="<?php echo e('00:00'); ?>">
                  <input type="hidden" class="form-control disabled" readonly name="processing_time" value="<?php echo e(old('processing_time',$product->processing_time)); ?>">
                </div>
                <div class="col col-7">
                  ...
                  name="processing_time" id="processing_time_range" value="<?php echo e(old('processing_time',$product->processing_time)); ?>">
