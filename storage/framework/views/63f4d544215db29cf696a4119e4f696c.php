  ...
  <div class="row">
    ...
    <div class="col-md-12">
          ...
          <div class="row">
            <div class="col ">
              <div class="card card-body">
                <form action="/admin/sales-session/store" method="POST">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="input-group sm mt-2">
                    ...
                    <select class="form-select form-control sm py-0" name="monybox_id" id="monybox_id" required>
                      ...
                      <option value="<?php echo e($monyBox->id); ?>">
                        ...
                        <?php echo e(__('sessions.box_has_active_session')); ?>
      ...
      <table class="table table-striped mt-3">
        ...
        <tbody>
          <?php $__currentLoopData = $salesSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td><?php echo e($loop->iteration); ?></td>
            <td><?php echo e($session->monybox->name); ?></td>
            <td><?php echo e($session->admin->userName); ?></td>
            <td><?php echo e($session->opening_balance); ?></td>
            <td>
              <span class="badge bg-<?php echo e($session->status == 'Active' ? 'success' : 'danger'); ?>">
                <?php echo e($session->status == 'Active' ? __('sessions.active') : __('sessions.inactive')); ?>

              </span>
            </td>
            <td><?php echo e($session->start_time->format('Y-m-d H:i')); ?></td>
            <td>
              <a href="" class="btn btn-sm btn-info" title="<?php echo e(__('sessions.view_details')); ?>">
                <i class="fas fa-eye"></i>
              </a>
              <a href="<?php echo e(route('edit-sales-session-info',  $session)); ?>" class="btn btn-sm btn-warning" title="<?php echo e(__('sessions.edit')); ?>">
                <i class="fas fa-edit"></i>
              </a>
              <a href="<?php echo e(route('destroy-sales-session-info', $session)); ?>" class="btn btn-sm btn-danger" title="<?php echo e(__('sessions.delete')); ?>">
                <i class="fas fa-trash"></i>
              </a>
              <?php if($session->status == 'Active'): ?>
              <a href="<?php echo e(route('sales-session.close', $session->id)); ?>" class="btn btn-sm btn-secondary" title="<?php echo e(__('sessions.close_session')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\CashierApp\resources\views/admin/sales-session/index.blade.php ENDPATH**/ ?>