          ...
          <?php if($activeSessions): ?>
            <div class="list-group">
                ...
                <div class="list-group-item">
                  <h5 class="mb-1  pb-1 pt-1"><?php echo e(__('profile.session_name')); ?>: <strong><?php echo e('@'); ?></strong></h5>
                  <p class="mb-1  pb-1 pt-1"><?php echo e(__('profile.device_name')); ?>: <strong><?php echo e($activeSessions->device_name ?? '-'); ?></strong></p>
                  <p class="mb-1  pb-1 pt-1"><?php echo e(__('profile.cashbox_name')); ?>: <strong><?php echo e($activeSessions->monybox->name); ?></strong></p>
                  <p class="mb-1  pb-1 pt-1"><?php echo e(__('profile.total_orders')); ?>: <strong><?php echo e($activeSessions->orders->count()); ?></strong></p>
                  <p class="mb-1  pb-1 pt-1"><?php echo e(__('profile.total_revenue')); ?>:: <strong> <?php echo e(number_format($sessionSales, 2)); ?> <?php echo e(__('profile.currency')); ?></strong></p>
                  <p class="mb-1  pb-1 pt-1"><?php echo e(__('profile.cashbox_total')); ?>:: <strong> <?php echo e(number_format($activeSessions->cashbox_total, 2)); ?> <?php echo e(__('profile.currency')); ?></strong></p>
                  <p class="mb-1  pb-1 pt-1">
                            <?php if($activeSessions->status == 'Active'): ?>
                            ...
                            <?php if(isset($activeSessions) && $activeSessions->status == 'Active'): ?>
                                <a href="<?php echo e(route('fast-create-order', [ $activeSessions->id])); ?>" class="btn btn-sm btn-info">
