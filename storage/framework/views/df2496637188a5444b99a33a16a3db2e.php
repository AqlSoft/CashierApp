...
<h2 class="mt-4 pb-2" style="border-bottom: 1px solid #dedede">
  <i class="fa fa-edit px-1"></i> <?php echo e(__('sessions.update_shift')); ?>
    ...
    <div class="card-body">
      <form action="<?php echo e(route('update-shift-info')); ?>" method="POST">
        ...
        <div class="input-group sm mb-2">
          ...
          <input type="text" class="form-control sm" name="start_time" id="start_time" value="<?php echo e(old('start_time', $shift->start_time)); ?>">
          ...
          <select class="form-select form-control sm py-0" name="admin_id" id="admin_id">
            ...
            <option value="<?php echo e($admin->id); ?>" <?php echo e($shift->admin_id == $admin->id ? 'selected' : ''); ?>>
        ...
        <div class="input-group sm mt-2">
          ...
          <select class="form-select form-control sm py-0" name="monybox_id" id="monybox_id" required>
            ...
            <option value="<?php echo e($monyBox->id); ?>" <?php echo e($shift->monybox_id == $monyBox->id ? 'selected' : ''); ?>>
          ...
          <input type="text" class="form-control sm" name="notes" id="notes" value="<?php echo e(old('notes', $shift->notes)); ?>">

          <label class="input-group-text" for="opening_balance"><?php echo e(__('sessions.opening_balance')); ?></label>
          <input type="number" class="form-control sm" name="opening_balance" id="opening_balance" value="<?php echo e(old('opening_balance', $shift->opening_balance)); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\CashierApp\resources\views/admin/shifts/edit.blade.php ENDPATH**/ ?>