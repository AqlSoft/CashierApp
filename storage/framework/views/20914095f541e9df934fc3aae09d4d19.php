        ...
        <div
          ...
          <form action="<?php echo e(route('store-new-product')); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="input-group sm mb-2">
                ...
                <label class="input-group-text" for="cost_price"><?php echo e(__('products.cost_price')); ?></label>
              ...
              <div class="input-group sm mt-2">
                ...
                <label class="input-group-text" for="processing_time"><?php echo e(__('products.processing_time')); ?></label>
              ...
              <div class="input-group sm mt-2">
                ...
                <input type="file" class="form-control sm py-0" name="image" id="image" accept="image/*">
