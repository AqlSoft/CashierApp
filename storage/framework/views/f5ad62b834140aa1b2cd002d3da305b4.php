...
<div class="title-slider-header">
  <div class="title-new-section">
    <h1><?php echo e(__('orderitem.add_order_items')); ?></h1>
    <?php if(isset($shift) && $shift->status == 'Active'): ?>
    <a href="<?php echo e(route('fast-create-order', $shift->id)); ?>">
      <i class="fas fa-plus"></i> <?php echo e(__('orderitem.new')); ?>

    </a>
    <?php else: ?>
    <button class="btn btn-secondary" disabled>
      <i class="fas fa-plus"></i> <?php echo e(__('orderitem.no_active_shift')); ?>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <a href="<?php echo e(route('add-orderitem', [$pendingOrder->id])); ?>"
              title="<?php echo e(__('orderitem.order_sn')); ?> - <?php echo e($pendingOrder->order_sn); ?>" class="btn btn-sm <?php echo e($btnClass); ?>">
          ...
          <div class="swiper-slide">
            <span class="text-muted"><?php echo e(__('orderitem.no_pending_orders')); ?></span>
          </div>
          <?php endif; ?>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-sm">
    <form action="/admin/clients/store" method="POST">
      ...
      <div class="modal-content">
        <h1 class="modal-title fs-5 mt-2 ps-3" style="border-bottom: 1px solid #dedede"><?php echo e(__('orderitem.add_new_client')); ?></h1>
        <div class="modal-body">
          <div class="input-group sm mb-2">
            <label class="input-group-text" for="vat_number"><?php echo e(__('orderitem.vat_number')); ?></label>
            <input type="number" class="form-control sm" name="vat_number" id="vat_number">
          </div>
          <div class="input-group sm mb-2">
            <label class="input-group-text" for="name"><?php echo e(__('orderitem.client_name')); ?></label>
            <input type="text" class="form-control sm" name="name" id="name">
          </div>
          <div class="input-group sm mb-2">
            <label class="input-group-text" for="phone"><?php echo e(__('orderitem.phone_number')); ?></label>
            <input type="number" class="form-control sm" name="phone" id="phone">
          </div>
          <div class="input-group sm mb-2">
            <label class="input-group-text" for="address"><?php echo e(__('orderitem.address')); ?></label>
          ...
          <div class="input-group pt-2 px-3 mt-2 justify-content-end" style="border-top: 1px solid #dedede">
            <button type="button" class="btn px-3 py-1 btn-outline-secondary btn-sm"
              data-bs-dismiss="modal"><?php echo e(__('orderitem.close')); ?></button>
            <button type="submit" class="btn px-3 py-1 btn-primary btn-sm"><?php echo e(__('orderitem.save_client')); ?></button>
          </div>
        </div>
      </div>
    </form>
  ...
  <div class="row mt-3 d-flex gap-3">
      ...
      <div class="row mt-2 mb-2">
        <div class="btn-group ">
          <a class="btn btn-outline-secondary <?php echo e($order->delivery_method == 1 ? 'btn-secondary text-white':''); ?>"
            href="<?php echo e(route('change-order-delivery-method', [$order->id, 1])); ?>"><?php echo e(__('orderitem.takeaway')); ?></a>
          <a class="btn btn-outline-info <?php echo e($order->delivery_method == 2 ? 'btn-info text-black':''); ?>"
            href="<?php echo e(route('change-order-delivery-method', [$order->id, 2])); ?>"><?php echo e(__('orderitem.local')); ?></a>
          <a class="btn btn-outline-warning <?php echo e($order->delivery_method == 3 ? 'btn-warning text-black':''); ?>"
            href="<?php echo e(route('change-order-delivery-method', [$order->id, 3])); ?>"><?php echo e(__('orderitem.delivery')); ?></a>
        </div>
        ...
        <div class="col col-12 mt-2">
          ...
          <div class="input-group sm mb-2">
            <label class="input-group-text"><?php echo e(__('orderitem.table_number')); ?></label>
            <select class="form-select form-control sm py-0" name="table_id" id="table_id_select" <?php echo e($currentMethod == 2 ? 'required' : ''); ?>>
              <option value=""><?php echo e(__('orderitem.select_table')); ?></option>
              ...
              <option value="<?php echo e($table->id); ?>"
                ...
                <?php echo e($table->number); ?> (<?php echo e($table->is_occupied ? __('orderitem.occupied') : __('orderitem.available')); ?>)
              </option>
          ...
          <div class="input-group sm mb-2">
            <label class="input-group-text"><?php echo e(__('orderitem.delivery_agent')); ?></label>
            <select class="form-select form-control sm py-0" id="delivery_id_select"
              <?php echo e($currentMethod == 3 ? 'required' : ''); ?>>
              <option value=""><?php echo e(__('orderitem.select_agent')); ?></option>
          ...
          <div class="input-group sm mb-2">
            <label class="input-group-text"><?php echo e(__('orderitem.client')); ?></label>
            ...
            <label class="input-group-text" for="customer_id">
              <a class="btn btn-sm py-0" href="#" data-bs-target="#exampleModalToggle"
                ...
                <i class="fa-solid fa-user-plus" title="<?php echo e(__('orderitem.add_new_client')); ?>"></i>
              </a>
            </label>
          </div>
          <?php endif; ?>
          ...
          <div class="selected-products-container" style="font-size: 14px;">
            <div class="row g-0 border-bottom py-2 fw-bold align-items-center">
              ...
              <div class="col-3 ps-2 fw-bold fs-6"><?php echo e(__('orderitem.meal')); ?></div>
              <div class="col-2 text-center fw-bold fs-6"><?php echo e(__('orderitem.qty')); ?></div>
              <div class="col-2 text-center fw-bold fs-6"><?php echo e(__('orderitem.u_price')); ?></div>
              <div class="col-2 text-center fw-bold fs-6"><?php echo e(__('orderitem.t_price')); ?></div>
              <div class="col-2 text-center fw-bold fs-6"><?php echo e(__('orderitem.action')); ?></div>
            </div>
                ...
                <div class="col-2 text-center fs-6">
                  <div class="d-flex justify-content-center gap-1">
                    <button type="submit" class="btn btn-sm p-0 border-0 bg-transparent"
                      title="<?php echo e(__('orderitem.update_order_item')); ?>">
                      <i class="fas fa-save text-secondary fs-6"></i>
                    </button>
                    <a class="btn btn-sm p-0 border-0 bg-transparent"
                      onclick="return confirm('<?php echo e(__('orderitem.confirm_delete_item')); ?>')"
                      title="<?php echo e(__('orderitem.delete_order_item')); ?>"
          ...
          <div class="total-price mt-2 d-flex justify-content-between align-items-center">
            <h4><?php echo e(__('orderitem.total_price')); ?>:</h4>
          ...
          <div class="input-group pt-2 justify-content-center align-items-center gap-2">
            <a href="/admin/orders/index" class="btn px-3 py-1 btn-outline-secondary btn-sm"
              title="<?php echo e(__('orderitem.back_to_order_list')); ?>">
              <?php echo e(__('orderitem.back_to_order')); ?>
            ...
            <a href="<?php echo e(route('view-invoice', [$order->invoice->id])); ?>"
              ...
              <?php echo e(__('orderitem.view_invoice')); ?>
            ...
            <div class="dropdown">
              <button class="btn px-3 py-1 btn-outline-secondary btn-sm dropdown-toggle"
                ...
                <?php echo e(__('orderitem.finish')); ?>

              </button>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#" data-bs-target="#cashPaymentModal"
                    data-bs-toggle="modal"><?php echo e(__('orderitem.cash_payment')); ?></a></li>
              </ul>
            </div>
            <?php elseif($order->status === 3): ?>
            <a href="<?php echo e(route('allow-order-editting', [$order->id])); ?>"
              class="btn px-3 py-1 btn-outline-secondary btn-sm"><?php echo e(__('orderitem.allow_edit')); ?></a>
            <?php endif; ?>
          </div>
          </form>
        </div>
    ...
    <div class="btn-group ">
        <a class="btn btn-outline-secondary <?php echo e(request('category') == null ? 'active' : ''); ?>"
           href="<?php echo e(route('add-orderitem', ['id' => $order->id])); ?>"><?php echo e(__('orderitem.all')); ?></a> 
            ...
            <button type="submit" class="product-item">
              ...
              <div class="productlistcontent">
                ...
                <p style="border-top-left-radius: 5px" class="mb-3 quantity-display">
                  <?php echo e(__('orderitem.qty')); ?>:<?php echo e($quantities[$product->id] ?? 0); ?>
  ...
  <div class="modal-dialog modal-dialog-centered modal-sm">
    <div class="modal-content">
      <div class="modal-header" style="padding: 0.5rem 1rem; border-bottom: 1px solid #dedede;">
        <h1 class="modal-title fs-5" id="cashPaymentModalLabel"><?php echo e(__('orderitem.cash_payment')); ?></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo e(__('orderitem.close')); ?>"></button>
      </div>
      <form method="POST" action="<?php echo e(route('payments.cash.store')); ?>" id="orderForm">
        ...
        <div class="modal-body">
          <div class="input-group input-group-sm mb-2">
            <span class="input-group-text" style="width: 110px;"><?php echo e(__('orderitem.amount')); ?></span>
          ...
          <div class="input-group input-group-sm mb-2">
            <span class="input-group-text" style="width: 110px;"><?php echo e(__('orderitem.vat_amount')); ?></span>
          ...
          <div class="input-group input-group-sm mb-2">
            <span class="input-group-text" style="width: 110px;"><?php echo e(__('orderitem.total_amount')); ?></span>
          ...
          <hr class="my-2">
          <div class="input-group input-group-sm mb-2">
            <span class="input-group-text" style="width: 110px;"><?php echo e(__('orderitem.paid')); ?></span>
          ...
          <div class="input-group input-group-sm mb-1">
            <span class="input-group-text" style="width: 110px;"><?php echo e(__('orderitem.remaining')); ?></span>
        ...
        <div class="modal-footer" style="border-top: 1px solid #dedede; padding: 0.5rem;">
          <button type="button" class="btn px-3 py-1 btn-outline-secondary btn-sm"
            data-bs-dismiss="modal"><?php echo e(__('orderitem.close')); ?></button>
          <button type="submit" class="btn px-3 py-1 btn-primary btn-sm"><?php echo e(__('orderitem.confirm')); ?></button>
        </div>
      </form>
    </div>
  </div>
